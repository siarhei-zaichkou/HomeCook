...
extension Cook {
    static func getCooks() -> [Cook] {
        ...
        Cook(name: "Ольга Тегза", description: "Квалифицированный повар приготовит диетические, вегетарианские и просто вкусные блюда разных кухонь мира, сможет провести и обслужить банкеты, фуршеты, семейные праздники.", rate: 35, photo: "olya"),
